...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '•𝐑𝐀𝐌𝐒𝐈𝐒•;ramsis;0;https://i.imgur.com/pgujvxK.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBItb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA,
    BOT_NAME: process.env.BOT_NAME || '𝐑𝐚𝐦𝐬𝐢𝐬',
